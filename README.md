...
![hdbscan](https://img.shields.io/badge/hdbscan-0.8.33+-4B8BBE)
![folium](https://img.shields.io/badge/folium-0.14+-77B829?logo=leaflet&logoColor=white)
![Jupyter](https://img.shields.io/badge/Jupyter-Notebook-F37626?logo=jupyter&logoColor=white)
![Last commit](https://img.shields.io/github/last-commit/reidsendroff/Geospatial_Clustering-)
...
$$
\text{PAI}@k = \frac{n_i / N}{a_i / A}
$$

where $n_i$ = future crimes inside the predicted hotspot zone, $N$ = total future crimes,
$a_i$ = hotspot area, $A$ = total study area. At $k = 5\%$, the top-5% of KDE-scored
points define the hotspot zone. A random model yields PAI = 1.0; values above 1 indicate
concentration of risk.

Future crimes are drawn from the last 30 days of the full 100k dataset (held out from training):

```text
Validation window: 2025-09-11 → 2025-10-11
Validation records: 19,762
PAI@5%           = 16.23%   (3.25x lift over random)
```
...
<p align="center">
  <img src="images/hdbscan_spatial_clusters.png" width="700" alt="HDBSCAN Spatial Clusters — Chicago Crime">
</p>

<p align="center">
  <img src="images/kde_density_heatmap.png" width="700" alt="KDE Crime Density Heatmap">
</p>
